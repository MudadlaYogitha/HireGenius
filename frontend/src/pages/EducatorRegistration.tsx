...
const EducatorRegistration: React.FC = () => {
      ...
      <div className="w-full max-w-sm sm:max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100">
          ...
          <div className="text-center mb-4 sm:mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-1">Create Educator Account</h2>
            <p className="text-gray-600 text-xs sm:text-sm">Join our educational community</p>
          </div>
